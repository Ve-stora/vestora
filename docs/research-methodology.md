...
Vestora's ML components address underexplored problems in computational finance — specifically the application of modern forecasting and anomaly detection techniques to thin, low-liquidity emerging market exchanges in East Africa and Africa. This document outlines the data sources, model architecture, evaluation approach, and open research questions.
...
**Scope**: African financial news, NSE company announcements, regulatory filings
